...
def generateTraditionalPuzzle(width, height):
    ...
    piece_list = PieceList(height, width)
    piece_dict = {}
    piece_nubinfo = [None] * width * height

    def mark_nub(x, y, side, type):
        idx = x + y * width
        if piece_nubinfo[idx] is None: piece_nubinfo[idx] = {}
    ...
    print("inside_corners", inside_corners)
    print("outside_corners", outside_corners)
    print("piece_nubinfo", piece_nubinfo)
